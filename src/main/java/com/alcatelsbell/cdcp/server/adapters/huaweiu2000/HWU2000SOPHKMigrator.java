 ...
 */
public class HWU2000SOPHKMigrator  extends AbstractDBFLoader {

    public HWU2000SOPHKMigrator(String fileUrl, String emsdn) {
    ...
    public HWU2000SOPHKMigrator(Serializable object, String emsdn) {
        this.emsdn = emsdn;
 ...
 //   private HashMap<String,List<CTP>> ptpCtpMap = new HashMap<String, List<CTP>>();
    ...
    public void doExecute() throws Exception {
        ...
        logAction(emsdn + " migrateManagedElement", "同步子网", 2);
...
//        fileLogger.info("abc");
        URL resource = HWU2000SOPHKMigrator.class.getClassLoader().getResource("META-INF/persistence.xml");
...
//        }
        ...
        HWU2000SOPHKMigrator loader = new HWU2000SOPHKMigrator (fileName, emsdn){
